                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [Expanded(child: Text('Delivery Address'.tr, overflow: TextOverflow.ellipsis, style: const TextStyle(color: ThemeProvider.appColor, fontFamily: 'bold', fontSize: 15)))],
                          ),
                        ),
                        Padding(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    value.currencySide == 'left' ? value.currencySymbol + value.productOrderDetails.discount.toString() : value.productOrderDetails.discount.toString() + value.currencySymbol,
                                    overflow: TextOverflow.ellipsis,
                                    textAlign: TextAlign.end,
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    value.currencySide == 'left' ? value.currencySymbol + value.productOrderDetails.walletPrice.toString() : value.productOrderDetails.walletPrice.toString() + value.currencySymbol,
                                    overflow: TextOverflow.ellipsis,
                                    textAlign: TextAlign.end,
                                    style: const TextStyle(color: ThemeProvider.greyColor, fontSize: 15),
                                  ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    value.currencySide == 'left' ? value.currencySymbol + value.productOrderDetails.deliveryCharge.toString() : value.productOrderDetails.deliveryCharge.toString() + value.currencySymbol,
                                    overflow: TextOverflow.ellipsis,
                                    textAlign: TextAlign.end,
                                    style: const TextStyle(color: ThemeProvider.greyColor, fontSize: 15),
                                  ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    value.currencySide == 'left' ? value.currencySymbol + value.productOrderDetails.total.toString() : value.productOrderDetails.total.toString() + value.currencySymbol,
                                    overflow: TextOverflow.ellipsis,
                                    textAlign: TextAlign.end,
                                    style: const TextStyle(color: ThemeProvider.greyColor, fontSize: 15),
                                  ),
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  value.currencySide == 'left' ? value.currencySymbol + value.productOrderDetails.grandTotal.toString() : value.productOrderDetails.grandTotal.toString() + value.currencySymbol,
                                  overflow: TextOverflow.ellipsis,
                                  textAlign: TextAlign.end,
