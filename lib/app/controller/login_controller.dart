  ...
  Future<void> onLogin() async {
    ...
    if (response.statusCode == 200) {
      ...
      if (myMap['user'] != '' && myMap['token'] != '' && myMap['user']['type'] != 'user') {
        ...
        parser.saveInfo(myMap['user']['id'].toString(), myMap['user']['first_name'].toString(), myMap['user']['last_name'].toString(), myMap['user']['cover'].toString(), myMap['user']['email'].toString(),
            myMap['user']['mobile'].toString(), myMap['user']['type'].toString());
        if (myMap['user']['type'].toString() == 'individual') {
          ...
          parser.saveOtherInfo(myMap['salon']['name'].toString(), myMap['salon']['cover'].toString(), 'NA', double.parse(myMap['salon']['rating'].toString()), myMap['salon']['total_rating'].toString());
        }
