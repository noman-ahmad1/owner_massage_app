      ...
      builder: (context, child) {
        return Theme(
          data: Theme.of(context).copyWith(
            colorScheme: ColorScheme.light(primary: ThemeProvider.appColor.withValues(alpha: 0.7), onPrimary: ThemeProvider.whiteColor, onSurface: ThemeProvider.blackColor),
